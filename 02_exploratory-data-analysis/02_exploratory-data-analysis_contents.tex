...
\begin{frame}{Two numeric variables: scatter plots}
    ...
    \footnotesize
    \begin{itemize}
        \item Above is a scatterplot that shows the relationship between car weight and car milage using the `mtcars' dataset
...
\begin{frame}{EDA checklist and tools}
    \begin{enumerate}
        ...
        \item Record findings and decisions in a script
    \end{enumerate}
\end{frame}
