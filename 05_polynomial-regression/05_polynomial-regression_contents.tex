...
\begin{frame}{Collinearity among the powers}
    \begin{itemize}
        ...
        \item \textbf{Orthogonal polynomials} (R: \texttt{poly(x, 2)}) go one step further and make the columns exactly uncorrelated; the fitted curve is the same, but the individual coefficients are no longer interpretable
