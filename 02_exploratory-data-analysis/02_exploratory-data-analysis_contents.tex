...
\begin{frame}{Time series: trend, seasonality, variance}
    ...
    \footnotesize
    \begin{itemize}
        \item Plot against time first; look for trend, seasonality, changing variance, and breaks; the yearly mean rises from 126.7 to 476.2 thousand over 1949--1960
